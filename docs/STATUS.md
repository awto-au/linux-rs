# Status — 2026-07-18T12:18:09+10:00

![status](status/status.png)

- Translated TUs: **32**   ·   KUnit: **16 suites, 143 vectors** green   ·   Rules: **27** (t1 18 / t2 4 / t3 5)
...
| TU | readiness |
|---|---|
| lib/strncpy_from_user.c | 87.3% |
| lib/usercopy.c | 85.2% |
| lib/lzo/lzo1x_decompress_safe.c | 81.3% |
| lib/bucket_locks.c | 77.8% |
| lib/group_cpus.c | 77.8% |
| lib/zlib_inflate/inftrees.c | 77.4% |
| lib/glob.c | 75.9% |
| lib/string_helpers.c | 75.1% |
| lib/zstd/common/entropy_common.c | 74.4% |
| lib/decompress_unlzo.c | 70.8% |
