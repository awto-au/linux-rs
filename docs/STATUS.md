# Status — 2026-07-31T13:09:39+10:00

![status](status/status.png)

- Translated TUs: **38**   ·   KUnit: **18 suites, 156 vectors** green   ·   Rules: **31** (t1 21 / t2 5 / t3 5)
- Wired into live boot path: **6 functions across 1 file(s)** (vs. **38** total TUs landed) — see [docs/streams.md](streams.md)'s stream 2 ("c2rust-boot-blocker") for why this is the harder, more important milestone: a standalone `lib/` swap compiling clean is not the same as real Rust executing at a live, pre-existing C call site.
...
| TU | readiness |
|---|---|
| lib/zlib_inflate/inftrees.c | 80.0% |
| lib/bucket_locks.c | 77.8% |
| lib/group_cpus.c | 77.8% |
| lib/lzo/lzo1x_decompress_safe.c | 77.3% |
